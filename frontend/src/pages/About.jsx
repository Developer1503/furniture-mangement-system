...
const About = () => {
  return (
    <div className="w-full min-h-screen flex flex-col items-center bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden pb-16 ">
  <Squares
    speed={0.5}
  ...
  <motion.div
    ...
    className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center p-4 pointer-events-none"
  >
    ...
    <p className="text-lg sm:text-xl max-w-lg">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-center mt-20 lg:mt-40 px-6 lg:px-16">
        ...
        <div className="lg:w-1/2 text-left mb-10 lg:mb-0">
          <h2 className="text-3xl lg:text-4xl font-bold mb-8 pb-4">Handcrafted Solid Wood Furniture</h2>
